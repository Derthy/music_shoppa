...
<html>
	...
	<body>
		...
		<div id="create-products" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:productsInstance, action:'save']"  enctype="multipart/form-data">
				<fieldset class="form">
					<g:render template="form"/>
				</fieldset>
				<sec:ifAnyGranted roles="ROLE_ADMIN">
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'label.addProduct', default: 'Create')}" />
				</fieldset>
				</sec:ifAnyGranted>
			</g:form>
		</div>
